...
/** Windows-1250 (CP-1250) encoding
 * Central and Eastern European language Microsoft Windows code page encoding.
 */
class Windows1250 : 
...
protected:
   /**
    * 80 to FF codes translation table.
    */
   static const _uint16 _table[0x80];
   
   
public:

   /**
    * Create an Windows-1250 encoding.
    */
   Windows1250();
